...
15 years securing enterprise networks (Nike, Assurant) taught me to build systems that are safe to leave running. Now I bring that same discipline to AI automation: least-access by default, clear rules for "done," and your data staying yours.
...
**Stack:** TypeScript/React · Python · Supabase/Postgres · Anthropic Claude · RAG · APIs & webhooks · Azure · network security

📫 dwilliams@harbormill.net · 💼 [LinkedIn](https://www.linkedin.com/in/damon-w-67882768) · 🌐 [harbormill.net](https://harbormill.net)
